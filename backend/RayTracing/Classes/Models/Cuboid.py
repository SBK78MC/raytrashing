...
class Cuboid(Object3D):
    ...
    def __init__(self, x=0, y=0, z=0, w=0, h=0, d=0, color=Color(), specular=100, reflection=0.1):
    ...
    def __init__(self, v=Vector(0,0,0), w=0, h=0, d=0, color=Color(), specular=100, reflection=0.1):
