...
class Sphere(Object3D):
    ...
    def __init__(self, x=0, y=0, z=0, radius=0, color=Color(), specular=50, reflection=0.2):
        super().__init__(x, y, z, color, specular, reflection)
        self.radius = radius

    def __init__(self, v=Vector(0, 0, 0), radius=0, color=Color(), specular=50, reflection=0.2):
